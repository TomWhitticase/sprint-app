      ...
      <main className="flex flex-col w-full gap-2 p-4">
        <div className="flex flex-col items-start justify-start gap-2 p-4 bg-white border-2 rounded-lg">
          <div className="flex items-center justify-between w-full">
            <span className="text-xl font-bold tracking-wide uppercase spacing text-system-grey-extraLight">
              {task?.name}
            </span>
            <Button
          ...
          <Divider />
          <div className="flex items-start justify-center w-full gap-8 mobile-only:flex-col desktop-only:flex-row">
